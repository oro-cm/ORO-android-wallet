...
{
	public static boolean TEST = R.class.getPackage().getName().contains("_test");
	...
	public final static class Files
	{
		...
		public static final String EXTERNAL_WALLET_KEY_BACKUP = "oro-wallet-keys" + FILENAME_NETWORK_SUFFIX;

		/** Filename of the manual wallet backup. */
		public static final String EXTERNAL_WALLET_BACKUP = "oro-wallet-backup" + FILENAME_NETWORK_SUFFIX;
	...
	private static final String EXPLORE_BASE_URL_PROD = "http://explorer.oro.net/chain/Oro/";
	private static final String EXPLORE_BASE_URL_TEST = "http://explorer.oro.net/chain/Oro-testnet/";
	...
	public static final String VERSION_URL = "https://android-wallet.oro.org/version";

	/** MIME type used for transmitting single transactions. */
	public static final String MIMETYPE_TRANSACTION = "application/x-orotx";

	/** MIME type used for transmitting wallet backups. */
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-oro-wallet-backup";

	/** Number of confirmations until a transaction is fully confirmed. */
	public static final int MAX_NUM_CONFIRMATIONS = 7;

	/** User-agent to use for network access. */
	public static final String USER_AGENT = "Oro Wallet";
	...
	public static final String REPORT_EMAIL = "webmaster@oro.org";
	...
	public static final String SOURCE_URL = "https://github.com/OroOrg/android-oro-wallet";
	public static final String BINARY_URL = "https://github.com/OroOrg/android-oro-wallet/releases";
