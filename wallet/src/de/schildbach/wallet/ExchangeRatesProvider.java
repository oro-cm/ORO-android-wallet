...
public class ExchangeRatesProvider extends ContentProvider
{
	...
	{
		final String authority = "org.oro.wallet";
...
//				newExchangeRates = requestExchangeRates(BLOCKCHAININFO_URL, userAgent, BLOCKCHAININFO_SOURCE, BLOCKCHAININFO_FIELDS);
			...
			if (newExchangeRates != null)
			{
				...
				final ExchangeRate oroExchangeRate = new ExchangeRate(new org.bitcoinj.utils.ExchangeRate(Coin.valueOf(1,0), Fiat.valueOf("USD", 10000)), null);
				exchangeRates.put(oroExchangeRate.getCurrencyCode(), oroExchangeRate);
			}
		}
		...
		try
		{
			...
			if (responseCode == HttpURLConnection.HTTP_OK)
			{
				...
				for (final Iterator<String> i = head.keys(); i.hasNext();)
				{
					...
					if (currencyCode != null && !"timestamp".equals(currencyCode) && !MonetaryFormat.CODE_ORO.equals(currencyCode)
							&& !MonetaryFormat.CODE_MORO.equals(currencyCode) && !MonetaryFormat.CODE_UORO.equals(currencyCode))
					{
